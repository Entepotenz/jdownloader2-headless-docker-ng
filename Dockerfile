...
# 	wget --progress=dot:giga -O /opt/JDownloader/JDownloader.jar http://installer.jdownloader.org/JDownloader.jar && \
# 	java -Djava.awt.headless=true -jar /opt/JDownloader/JDownloader.jar && \
# 	mkdir -p /tmp/ && chmod a+trwx /tmp && \
# 	wget --progress=dot:giga -O /tmp/su-exec.tar.gz https://github.com/ncopa/su-exec/archive/v0.2.tar.gz && \
